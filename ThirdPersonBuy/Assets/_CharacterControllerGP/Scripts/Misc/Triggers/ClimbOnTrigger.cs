...
{
    /// <summary>
    /// climb to obstacle trigger
    /// </summary>
    public class ClimbOnTrigger : Trigger
    {
        /// <summary>
        ...
        public override bool start(TPCharacter character, IKHelper limbsIK, bool use, bool secondaryUse, bool jump, float v, float h)
        {
            ...
            if (turnToLedge)
            {
                ...
                else
                {
                    ...
                    else m_TriggerInfo.avatarTarget = AvatarTarget.LeftHand;
                }

                m_TriggerInfo.transform = Target;
                m_TriggerInfo.pos_offset = closest - Target.position;
                m_TriggerInfo.stateName = "Base Layer.TRIGGERS.ClimbOn";
