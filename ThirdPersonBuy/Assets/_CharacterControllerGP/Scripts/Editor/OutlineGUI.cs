...
{
    /// <summary>
    /// GUI for use of StandardSpecularOutline shader
    /// </summary>
    internal class OutlineShaderGUI : ShaderGUI
    {
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            outlineWidthProp = FindProperty("_Outline", props);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                m_MaterialEditor.ColorProperty(outlineColorProp, "Outline Color");
                m_MaterialEditor.FloatProperty(outlineWidthProp, "Outline Width");
